...
return [
    ...
    'description' => 'Dokumentasi endpoint API untuk backend DOMPET/Zaku.',
    ...
    'intro_text' => <<<'INTRO'
            ...
            <aside>Untuk endpoint yang membutuhkan login, isi token JWT dari endpoint login pada tombol Authenticate.</aside>
        INTRO,
    ...
    'auth' => [
        ...
        'extra_info' => 'Dapatkan token dari endpoint <code>POST /api/auth/login</code>, lalu kirim sebagai Bearer token.',
    ],
